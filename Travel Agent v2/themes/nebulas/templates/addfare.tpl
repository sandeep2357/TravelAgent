<form method="post" action="admin.php?op=fare" name="frm_addfare">
<table align=center width=100% bgcolor=#FFCC66>
<tr><td>
<fieldset>
<legend>Add new far</legend>
<table>
...
<tr><td align="right">Departure first*</td><td><input type="text" value="{$date1|escape}" name="date1" maxlength=10 size=10 onFocus=this.blur()>  <a href="javascript:void(window.open( 'calendar.php?date1&formName=frm_addfare', '', 'width=200,height=210,top=120,left=120' ))"><img src="images/calender.gif" border=0 align=absmiddle></a>
<small><font color=red>{validate  field="date1" criteria="notEmpty" message="Please enter departure first date."}</font></small>

</td></tr>
<tr><td align="right">Departure last*</td><td><input type=text name=date2  value="{$date2|escape}" maxlength=10 size=10 onFocus=this.blur()>  <a href="javascript:void(window.open( 'calendar.php?date2&formName=frm_addfare', '', 'width=200,height=210,top=120,left=120' ))"><img src="images/calender.gif" border=0 align=absmiddle></a>
...
<tr><td></td><td><input type="submit" value="Add fare"></td></tr>
</table>
</td></tr>
</fieldset>
</table>
